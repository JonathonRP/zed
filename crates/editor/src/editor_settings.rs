...
pub use settings::{
    ...
    GoToDefinitionFallback, GoToDefinitionScrollStrategy, LspDocumentColorInlayPosition,
    LspDocumentColorInlayShape, MinimapThumb, MinimapThumbBorder, MultiCursorModifier,
...
pub struct EditorSettings {
    ...
    pub lsp_document_color_inlay_position: LspDocumentColorInlayPosition,
...
impl Settings for EditorSettings {
    fn from_settings(content: &settings::SettingsContent) -> Self {
        ...
        Self {
            ...
            lsp_document_color_inlay_position: editor.lsp_document_color_inlay_position.unwrap(),
